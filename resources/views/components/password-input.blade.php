...
<div class="relative" x-data="{ show: false }">
    ...
    <button type="button"
            @click="show = !show"
            class="absolute inset-y-0 right-0 flex w-11 items-center justify-center text-creamDim/70 transition hover:text-neon focus:outline-none"
            :title="show ? 'Sembunyikan password' : 'Intip password'"
